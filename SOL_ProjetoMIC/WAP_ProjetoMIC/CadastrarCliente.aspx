...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Label ID="Lbl_LimiteCompras" runat="server" Text="Limite de Compras: "></asp:Label><asp:TextBox ID="CaixaTexto_LimiteCompras" runat="server" TextMode="Number"></asp:TextBox>
        <br />
        <asp:Label ID="Lbl_LimiteCredito" runat="server" Text="Limite de Crédito: "></asp:Label><asp:TextBox ID="CaixaTexto_LimiteCredito" runat="server" TextMode="Number"></asp:TextBox>
        <br />
        <asp:Label ID="Lbl_DataNascimento" runat="server" Text="Data de Nascimento: "></asp:Label><asp:TextBox ID="CaixaTexto_DataNascimento" runat="server" TextMode="Date"></asp:TextBox>
        ...
        <asp:Button ID="Botao_Salvar" runat="server" Text="Salvar" OnClick="Botao_Salvar_Click1" /><asp:Button ID="Botao_Cancelar" runat="server" Text="Cancelar" OnClick="Botao_Cancelar_Click" />
    </form>
</body>
</html>
